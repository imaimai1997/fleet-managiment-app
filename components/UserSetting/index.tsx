  ...
  return (
    <>
      ...
      <div className="w-3/6 mx-auto text-right">
        <div className="p-6 flex flex-col border-2 border-black rounded-sm *:text-lg [&_input]:w-80 [&_input]:border-2 [&_input]:border-primary-700 [&_input]:p-2 [&_div]:flex [&_div]:justify-between [&_div]:items-center ">
          <form>
